...
touchPanSpeedCoeffFactor:1,capturedKeyNumbers:[16,17,27,37,38,39,40,61,65,68,83,87,107,109,173,187,189],friction:0.15,strings:{loadButtonLabel:"Iniciar <br>Recorrido",loadingLabel:"Cargando...",bylineLabel:"by %s",noPanoramaError:"No panorama image was specified.",fileAccessError:"The file %s could not be accessed.",malformedURLError:"There is something wrong with the panorama URL.",iOS8WebGLError:"Due to iOS 8's broken WebGL implementation, only progressive encoded JPEGs work for your device (this panorama uses standard encoding).",
    ...
    pannellum.viewer("panoramica", {
      ...
      scenes: {
        entrada1: {
          ...
          panorama:"src/assets/Proyecto/RECORRIDO/images/IMG_20221112_104137_00_003.jpg",
          hotSpots: [ 
            {
              //FLECHA ARRIBA
              pitch: -15,
